...
$status=1;
$query=mysqli_query($con,"insert into tblposts(PostTitle,Autor,Description,CategoryId,SubCategoryId,PostDetails,PostUrl,Is_Active,PostImage) values('$posttitle','$autor','$description','$catid','$subcatid','$postdetails','$url','$status','$imgnewfile')");
if($query)
{
